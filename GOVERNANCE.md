...
**Arquivos protegidos** (auditados e selados em `v1.7.0-motor-us`):
...
3. A tag `v1.7.0-motor-us` marca o snapshot auditado atual. Para restaurar: `git checkout v1.7.0-motor-us -- <arquivo>`.
