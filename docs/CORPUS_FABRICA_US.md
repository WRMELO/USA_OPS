...
| L-US-41 | **Paridade metodologica fiel com a fabrica de referencia pode produzir resultado diferente entre mercados - isso e evidencia valida, nao falha.** T-088C replicou exatamente o T-088 BR (blocked_b=Regra1+runs_value, blocked_bc=blocked_b+runs_disp, min_market_cap=300M) e obteve INCONCLUSIVO em vez de IMPLEMENTAR_BC (BR). O gate B+C caiu de 43.65% para ~13.2% confirmando que os bracos estavam corretos; a protecao de cauda simplesmente nao se replicou no universo US Russell+SC600 com momentum M3. Aceitar INCONCLUSIVO sem fishing post-hoc e disciplina cientifica necessaria. | D-079, D-078, D-076, D-070 |
| L-US-42 | **Em holdings com aviso consultivo Nelson/WE, a priorizacao de venda discricionaria deve usar a forma da curva, nao o i_value diario isolado.** Em 21/05/2026, KOPN, RELY e STRO concentraram simultaneamente: deterioracao forte de rank no Master (22->57, 30->206 e 7->69 em cerca de 5 pregoes), inclinacao negativa na curva normalizada de close_operational nos ultimos 5 pregoes (~-3,1%, -3,2% e -5,3% ao dia), drawdown material desde o pico local de 10 pregoes (-20,8%, -14,0% e -22,6%) e Nelson/WE de baixa ativo. STRO e o caso-chave: mesmo com aquecimento acumulado desde a ignicao ainda positivo (+33,2%), a curva ja havia entrado em rollover forte. Logo, quando houver Nelson/WE consultivo, a triagem de venda deve olhar a inclinacao de close_operational normalizado ou do logret acumulado desde pico local; a derivada do i_value bruto e ruidosa demais para capturar a impressao visual do Owner. O mesmo boletim mostrou o contrapeso: STM e VSH tinham slope negativo, mas drawdown raso, enquanto SATL e VPG nao tinham slope de baixa consistente. Portanto, derivada so faz sentido como camada de priorizacao dentro do alerta SPC, nunca isoladamente. | Owner 2026-05-21, casos KOPN/RELY/STRO; boletim 2026-05-19 |
