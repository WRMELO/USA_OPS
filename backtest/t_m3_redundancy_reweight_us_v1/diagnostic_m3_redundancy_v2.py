...
Read-only study script for T-SDC-M3-REDUNDANCY-REWEIGHT-US-V1.
"""
...
IN_MANIFEST = ROOT / "backtest" / "research_dataset_us_v2" / "manifest.json"
OUT_DIR = ROOT / "backtest" / "t_m3_redundancy_reweight_us_v1" / "results"
OUT_JSON = OUT_DIR / "diagnostic_z_m0_z_ret_correlation_v2.json"
